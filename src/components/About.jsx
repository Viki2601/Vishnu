...
export default function About() {
    ...
    return (
        <section ref={sectionRef} className="relative w-full h-full flex items-center justify-center overflow-hidden py-12 md:py-28 px-4 md:px-14 lg:px-20 rounded-4xl border border-amber-500/20 shadow-lg shadow-amber-500">
