...
export default function Contact() {
    return (
        <div className='relative min-h-screen w-full p-4 lg:p-10 flex flex-col justify-center items-center gap-y-10'>
            <div className='w-52 h-52 absolute top-30 lg:top-10 left-3 lg:left-96 -z-10'>
            ...
            <StarsAndMeteors />
            <h1 className='bg-clip-text font-extrabold tracking-tighter text-transparent bg-gradient-to-r from-stone-300 to-stone-800 text-7xl'>Contact</h1>
            <div className='w-full max-w-2xl bg-opacity-50 backdrop-filter backdrop-blur-lg flex flex-col items-center rounded-2xl border border-stone-500 py-6 px-4 z-10'>
                <div className='w-full flex flex-col items-start gap-6'>
                    <div className='flex flex-col gap-3'>
                        ...
                        <h1 className='text-stone-300 text-lg'>You can connect with me on LinkedIn <a href='https://www.linkedin.com/in/vishnu-muthukumar-0b247021a/' target='_blank' rel="noreferrer" className='text-blue-800 font-bold underline'>here.</a> </h1>
                    </div>
                    <div className='flex flex-col gap-3'>
                        ...
                        <h1 className='text-stone-300 text-lg'>You can view my GitHub profile and explore my projects <a href='https://github.com/Viki2601' target='_blank' rel="noreferrer" className='text-blue-800 font-bold underline'>here.</a> </h1>
                    </div>
                </div>
            </div>
        </div>
